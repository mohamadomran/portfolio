        ...
        >
          {pinnedRepos.map((repo) => (
            <Card as="li" key={repo.name}>
              ...
              <div className="z-10 flex space-x-16 sm:space-x-0 sm:justify-between mt-8 items-center w-full group text-sm text-zinc-500 dark:text-zinc-400">
                ...
                <div className="flex space-x-6">
                  ...
                  <p className="flex items-center">
                    ...
                    <ShareIcon className="order-first mr-2 w-5 h-5 fill-zinc-400 dark:fill-zinc-500 -rotate-90" />
                  </p>
                </div>
              </div>
            </Card>
