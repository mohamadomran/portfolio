...
const BlogArticle = ({ title, content }: Blog) => {
  return (
    <article className="self-center px-6 w-full  md:my-4 max-w-2xl lg:max-w-3xl prose prose-xl">
      <h2 className="mb-4 font-bold text-3xl text-base-content">{title}</h2>
