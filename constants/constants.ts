...
export const ABOUT_SEO_TITLE = 'About / Mohamad Omran';
...
export const ABOUT_SEO_DESCRIPTION = `Learn more about my background, experience, and passion for software engineering. Explore my story, discover my expertise, and see why I'm the right choice for your next project`;
...
export const GITHUB_SEO_DESCRIPTION = `Open Source Projects/Tinkering: My Contributions to the Community`;
