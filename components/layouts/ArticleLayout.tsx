...
export function ArticleLayout({
    ...
    return (
        <>
            <Head>
                <title>{`${title} - Mohamad Omran`}</title>
                    ...
                    <div className='mx-auto max-w-2xl'>
                        <Link href='/writing' replace>
                            <button
                                ...
                                <ArrowDownIcon className='h-4 w-4 stroke-zinc-500 transition group-hover:stroke-zinc-700 dark:stroke-zinc-500 dark:group-hover:stroke-zinc-400 rotate-90' />
                            </button>
                        </Link>
                        <article>
